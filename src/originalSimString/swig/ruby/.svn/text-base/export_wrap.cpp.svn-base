...
#define SWIGTYPE_p_writer swig_types[12]
...
SWIGEXPORT void Init_simstring(void) {
  ...
  cGC_VALUE.klass = rb_define_class_under(mSimstring, "GC_VALUE", rb_cObject);
  ...
  cConstIterator.klass = rb_define_class_under(mSimstring, "ConstIterator", rb_cObject);
  ...
  cIterator.klass = rb_define_class_under(mSimstring, "Iterator", ((swig_class *) SWIGTYPE_p_swig__ConstIterator->clientdata)->klass);
  ...
  cStringVector.klass = rb_define_class_under(mSimstring, "StringVector", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_std__vectorT_std__string_std__allocatorT_std__string_t_t, (void *) &cStringVector);
  ...
  rb_define_method(cStringVector.klass, "dup", VALUEFUNC(_wrap_StringVector_dup), -1);
  rb_define_method(cStringVector.klass, "inspect", VALUEFUNC(_wrap_StringVector_inspect), -1);
  rb_define_method(cStringVector.klass, "to_a", VALUEFUNC(_wrap_StringVector_to_a), -1);
  rb_define_method(cStringVector.klass, "to_s", VALUEFUNC(_wrap_StringVector_to_s), -1);
  rb_define_method(cStringVector.klass, "slice", VALUEFUNC(_wrap_StringVector_slice), -1);
  rb_define_method(cStringVector.klass, "each", VALUEFUNC(_wrap_StringVector_each), -1);
  rb_define_method(cStringVector.klass, "select", VALUEFUNC(_wrap_StringVector_select), -1);
  rb_define_method(cStringVector.klass, "reject!", VALUEFUNC(_wrap_StringVector_rejectN___), -1);
  rb_define_alias(cStringVector.klass, "delete_if", "reject!");
  rb_define_method(cStringVector.klass, "delete_at", VALUEFUNC(_wrap_StringVector_delete_at), -1);
  rb_define_method(cStringVector.klass, "__delete2__", VALUEFUNC(_wrap_StringVector___delete2__), -1);
  ...
  rb_define_alias(cStringVector.klass, "<<", "push");
  rb_define_method(cStringVector.klass, "reject", VALUEFUNC(_wrap_StringVector_reject), -1);
  rb_define_method(cStringVector.klass, "at", VALUEFUNC(_wrap_StringVector_at), -1);
  ...
  rb_define_method(cStringVector.klass, "shift", VALUEFUNC(_wrap_StringVector_shift), -1);
  rb_define_method(cStringVector.klass, "unshift", VALUEFUNC(_wrap_StringVector_unshift), -1);
  rb_define_method(cStringVector.klass, "empty?", VALUEFUNC(_wrap_StringVector_emptyq___), -1);
  rb_define_method(cStringVector.klass, "size", VALUEFUNC(_wrap_StringVector_size), -1);
  rb_define_method(cStringVector.klass, "clear", VALUEFUNC(_wrap_StringVector_clear), -1);
  rb_define_method(cStringVector.klass, "swap", VALUEFUNC(_wrap_StringVector_swap), -1);
  rb_define_method(cStringVector.klass, "get_allocator", VALUEFUNC(_wrap_StringVector_get_allocator), -1);
  rb_define_method(cStringVector.klass, "begin", VALUEFUNC(_wrap_StringVector_begin), -1);
  rb_define_method(cStringVector.klass, "end", VALUEFUNC(_wrap_StringVector_end), -1);
  rb_define_method(cStringVector.klass, "rbegin", VALUEFUNC(_wrap_StringVector_rbegin), -1);
  rb_define_method(cStringVector.klass, "rend", VALUEFUNC(_wrap_StringVector_rend), -1);
  rb_define_method(cStringVector.klass, "erase", VALUEFUNC(_wrap_StringVector_erase), -1);
  rb_define_method(cStringVector.klass, "front", VALUEFUNC(_wrap_StringVector_front), -1);
  rb_define_method(cStringVector.klass, "back", VALUEFUNC(_wrap_StringVector_back), -1);
  rb_define_method(cStringVector.klass, "assign", VALUEFUNC(_wrap_StringVector_assign), -1);
  rb_define_method(cStringVector.klass, "resize", VALUEFUNC(_wrap_StringVector_resize), -1);
  rb_define_method(cStringVector.klass, "insert", VALUEFUNC(_wrap_StringVector_insert), -1);
  rb_define_method(cStringVector.klass, "reserve", VALUEFUNC(_wrap_StringVector_reserve), -1);
  rb_define_method(cStringVector.klass, "capacity", VALUEFUNC(_wrap_StringVector_capacity), -1);
  rb_define_method(cStringVector.klass, "map_bang", VALUEFUNC(_wrap_StringVector_map_bang), -1);
  rb_define_method(cStringVector.klass, "__delete__", VALUEFUNC(_wrap_StringVector___delete__), -1);
  ...
  cWriter.klass = rb_define_class_under(mSimstring, "Writer", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_writer, (void *) &cWriter);
  rb_define_alloc_func(cWriter.klass, _wrap_writer_allocate);
  rb_define_method(cWriter.klass, "initialize", VALUEFUNC(_wrap_new_writer), -1);
  rb_define_method(cWriter.klass, "insert", VALUEFUNC(_wrap_writer_insert), -1);
  rb_define_method(cWriter.klass, "close", VALUEFUNC(_wrap_writer_close), -1);
  cWriter.mark = 0;
  cWriter.destroy = (void (*)(void *)) free_writer;
  cWriter.trackObjects = 0;
  
  cReader.klass = rb_define_class_under(mSimstring, "Reader", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_reader, (void *) &cReader);
  rb_define_alloc_func(cReader.klass, _wrap_reader_allocate);
  rb_define_method(cReader.klass, "initialize", VALUEFUNC(_wrap_new_reader), -1);
  rb_define_method(cReader.klass, "retrieve", VALUEFUNC(_wrap_reader_retrieve), -1);
  rb_define_method(cReader.klass, "close", VALUEFUNC(_wrap_reader_close), -1);
  rb_define_method(cReader.klass, "measure=", VALUEFUNC(_wrap_reader_measure_set), -1);
  rb_define_method(cReader.klass, "measure", VALUEFUNC(_wrap_reader_measure_get), -1);
  rb_define_method(cReader.klass, "threshold=", VALUEFUNC(_wrap_reader_threshold_set), -1);
  rb_define_method(cReader.klass, "threshold", VALUEFUNC(_wrap_reader_threshold_get), -1);
  cReader.mark = 0;
  cReader.destroy = (void (*)(void *)) free_reader;
  cReader.trackObjects = 0;
}
